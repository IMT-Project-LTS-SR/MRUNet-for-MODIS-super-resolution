...
################### INDEX Coarse ###################################
    ...
    cols_i = path_index.shape[0] #Spatial dimension x
    rows_i = path_index.shape[1] #Spatial dimension y
# Read as array the index
    index = path_index
...
#     T_unmix = gdal.Open(path_unm)
    ...
    cols = T_unm.shape[0] #Spatial dimension x
    rows = T_unm.shape[1] #Spatial dimension y
