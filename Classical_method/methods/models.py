...
class Encoder_Decoder(nn.Module):
    ...
    """
    def __init__(self, num_layers, pretrained, num_input_images=1, scales=range(4), num_output_channels=1, use_skips=True):
    ...
    def forward(self, x):
        ...
        x2 = self.encoder.layer1(self.encoder.maxpool(x1))  # torch.Size([512, 64, 16, 16])
        x3 = self.encoder.layer2(x2)                        # torch.Size([512, 128, 8, 8])
        x4 = self.encoder.layer3(x3)                        # torch.Size([512, 256, 4, 4])
        x5 = self.encoder.layer4(x4)                        # torch.Size([512, 512, 2, 2])
