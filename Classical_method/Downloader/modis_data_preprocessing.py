...
def MODIS_Data_Preprocessing(year,product, num_threads):
    ...
    hdfs_path     = '/homes/g19tian/Documents/1_Projet3A/MODIS/MOD_{}_{}/hdfs_files'.format(year,sensor)
    tifs_1km_path = '/homes/g19tian/Documents/1_Projet3A/MODIS/MOD_{}_{}/tifs_files/1km'.format(year,sensor)
    tifs_2km_path = '/homes/g19tian/Documents/1_Projet3A/MODIS/MOD_{}_{}/tifs_files/2km'.format(year,sensor)
    tifs_4km_path = '/homes/g19tian/Documents/1_Projet3A/MODIS/MOD_{}_{}/tifs_files/4km'.format(year,sensor)
...
if __name__ == "__main__":
    years = list(np.arange(2017,2018))
    products = ["MOD11A1.061"] # LST: "MOD11A1.061", NDVI: "MOD13A2.061"
    # products = ["MOD13A2.061"] # LST: "MOD11A1.061", NDVI: "MOD13A2.061"
